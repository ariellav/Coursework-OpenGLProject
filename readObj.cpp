      ...
      mesh->vertices.push_back(v);
        ...
        bool foundSlash = false;
            ...
            istringstream s(line.substr(2));
              ...
              if (!foundSlash) //using a regular file
            {
              GLuint a,b,c;
              s >> a; s >> b; s >> c;
              a--; b--; c--;
              ...
              else //using crappy obj converter
            {
              GLuint a,b,c,intTrash;
              char charTrash;
              s >> a; s >> charTrash; s >> intTrash; s >> charTrash; s >> intTrash;
              s >> b; s >> charTrash; s >> intTrash; s >> charTrash; s >> intTrash;
              s >> c; s >> charTrash; s >> intTrash; s >> charTrash; s >> intTrash;
              a--; b--; c--;
              mesh->elements.push_back(a); mesh->elements.push_back(b); mesh->elements.push_back(c);
            }
    }
